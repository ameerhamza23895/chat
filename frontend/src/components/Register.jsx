...
const Register = React.memo(() => {
  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    console.log('[Register] API URL:', import.meta.env.VITE_API_URL || 'auto-detected');
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-4 py-8">
      <div className="max-w-md w-full bg-slate-800 rounded-2xl shadow-2xl p-6 md:p-8 border border-slate-700">
        <div className="text-center mb-6 md:mb-8">
          ...
          <p className="text-sm md:text-base text-slate-400">Create your account to get started.</p>
        </div>
